...
function Services() {
    return (
        <div className='img_bg' style={{backgroundImage: `url(https://media.istockphoto.com/id/1273852653/photo/old-scratched-film-strip-grunge-texture-background.jpg?s=612x612&w=0&k=20&c=OTzQ4ThsRnvLhAnia1iwcE997l-XHrAlfkTZDBrLcZA=)`, opacity:'100%' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                <div className='Butto_services1'>
                    <div>
                        <img style={{ float: 'right', borderRadius: 200 }} src={img2} />
                    </div>
                    <div >
                        ...
                        <h6 style={{ color: 'white', fontSize: 17, marginTop: -30, marginLeft: 10, fontWeight: "200" }}>Boost your visibility with our expert SEO services. We optimize your website’s content, structure, and keywords to enhance its search engine ranking and attract organic traffic. Our data-driven strategies help your business stand out in search results and reach potential customers effectively.</h6>
                ...
                <div className='Butto_services1'>
                    <div>
                        <img style={{ float: 'right' }} src={img3} />
                    </div>
                    <div >
                        <p style={{ color: 'white', marginTop: 50, width: '60%', marginLeft: 30, }}>MARKETING AND MANAGEMENT</p>
                        <h4 className='button_services_h4' style={{}}>SOCIAL AD</h4>
                        <h6 style={{ color: 'white', fontSize: 17, marginTop: -30, marginLeft: 10, fontWeight: "200" }}>Elevate your online presence with strategic social media management. We handle everything from content creation and curation to community engagement and analytics. Our approach ensures that your brand's voice is consistent, your audience is engaged, and your social media efforts drive meaningful results.</h6>
                        <a style={{textDecoration:'none', cursor:'pointer'}} href='/Contact'>  <button className='connect_services'>Connect With Us
                            <i id='buttonHoverss' className="bi bi-chevron-right"></i>
                ...
                <div className='Butto_services_data'>
                    <div>
                        <img style={{ float: 'right' }} src={img4} />
                    </div>
                    <div >
                ...
                <div className='Butto_services_data'>
                    ...
                    <div >
                        ...
                        <h4 style={{ color: 'white', fontSize: 59, marginTop: -10, width: '60%', marginLeft: 10 }}>SEO</h4>
                        <h6 style={{ color: 'white', fontSize: 17, marginTop: -70, marginLeft: 10, fontWeight: "200" }}>Build a strong and memorable identity with our branding services. We craft unique and cohesive brand strategies that define your voice, style, and message. From logo design to brand guidelines, we ensure your brand stands out and resonates with your audience across all platforms.</h6>
